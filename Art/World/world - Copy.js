...
let ft = new THREE.TextureLoader().load("/front.png");
let bck = new THREE.TextureLoader().load("back.png");
let left = new THREE.TextureLoader().load("left.png");
let right =new THREE.TextureLoader().load("right.png");
let top = new THREE.TextureLoader().load("top.png");
let btm = new THREE.TextureLoader().load("btm.png");

multiArray.push(new THREE.MeshBasicMaterial({map:ft}));
multiArray.push(new THREE.MeshBasicMaterial({map:bck}));
multiArray.push(new THREE.MeshBasicMaterial({map:left}));
multiArray.push(new THREE.MeshBasicMaterial({map:right}));
