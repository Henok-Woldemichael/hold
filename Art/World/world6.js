...
camera.position.set(-180,1000,3000);
scene.add(camera);
...
let ft = new THREE.TextureLoader().load("Cmaps/06nz.png");
let bck = new THREE.TextureLoader().load("Cmaps/06pz.png");
let top = new THREE.TextureLoader().load("Cmaps/06ny.png");
let btm = new THREE.TextureLoader().load("Cmaps/06py.png");
let rt = new THREE.TextureLoader().load("Cmaps/06nx.png");
let lt =new THREE.TextureLoader().load("Cmaps/06px.png");
