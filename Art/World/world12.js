...
let ft = new THREE.TextureLoader().load("Cmaps/12nz.jpg");
let bck = new THREE.TextureLoader().load("Cmaps/12pz.jpg");
let top = new THREE.TextureLoader().load("Cmaps/12py.jpg");
let btm = new THREE.TextureLoader().load("Cmaps/12ny.jpg");
let rt = new THREE.TextureLoader().load("Cmaps/12nx.jpg");
let lt =new THREE.TextureLoader().load("Cmaps/12px.jpg");
