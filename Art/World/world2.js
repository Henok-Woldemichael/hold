...
let ft = new THREE.TextureLoader().load("Cmaps/02nz.png");
let bck = new THREE.TextureLoader().load("Cmaps/02pz.png");
let top = new THREE.TextureLoader().load("Cmaps/02ny.png");
let btm = new THREE.TextureLoader().load("Cmaps/02py.png");
let rt = new THREE.TextureLoader().load("Cmaps/02nx.png");
let lt =new THREE.TextureLoader().load("Cmaps/02px.png");
