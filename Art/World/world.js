...
let ft = new THREE.TextureLoader().load("Cmaps/01nz.png");
let bck = new THREE.TextureLoader().load("Cmaps/01pz.png");
let top = new THREE.TextureLoader().load("Cmaps/01ny.png");
let btm = new THREE.TextureLoader().load("Cmaps/01py.png");
let rt = new THREE.TextureLoader().load("Cmaps/01nx.png");
let lt =new THREE.TextureLoader().load("Cmaps/01px.png");
