...
let ft = new THREE.TextureLoader().load("Cmaps/11nz.png");
let bck = new THREE.TextureLoader().load("Cmaps/11pz.png");
let top = new THREE.TextureLoader().load("Cmaps/11ny.png");
let btm = new THREE.TextureLoader().load("Cmaps/11py.png");
let rt = new THREE.TextureLoader().load("Cmaps/11nx.png");
let lt =new THREE.TextureLoader().load("Cmaps/11px.png");
...
const texturePlane = textureLoader.load('/./Images/11WynnYunn.png');
